...
class Lightbox {
    ...
    setupEventListeners() {
        ...
        document.addEventListener('keydown', (e) => {
            if (this.elements.lightbox.style.display !== 'none') {
    ...
    open(index) {
        ...
        this.updateImage();
        // Dùng style.display thay vì classList để tương thích QWebEngineView
        ...
        if (this.imageStore.count > 1) {
            this.elements.lightboxPrev.style.display = 'flex';
            this.elements.lightboxPrev.classList.remove('hidden');
            this.elements.lightboxNext.style.display = 'flex';
            this.elements.lightboxNext.classList.remove('hidden');
        }
        console.log('[Lightbox] Lightbox opened, display:', this.elements.lightbox.style.display);
    }
